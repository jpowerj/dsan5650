...
::: {.callout-note title="Option 1: Modeling Social Phenomena with PGMs" icon="false"}

**Moving from *vaguely-thinking-about* to *formally modeling***

* Example 1.1</b>: Writeup on Modeling <b><i>Cahiers de Doléances</i></b> <i>(Coming soon!)</i></li>

:::

::: {.callout-note title="Option 2: Pushing Towards the Asymptote of Causality" icon="false"}

**Taking an existing *associational* analysis and tackling confounders**

* **Example 2.1**: Writeup on improving estimates of **labor market monopsony** *(Coming soon!)*
...
::: {.callout-note title="Option 1: Modeling Social Phenomena with PGMs" collapse="false" icon="false"}
...
::: {.callout-note title="Option 2: Associational $\leadsto$ Causal Analysis" collapse="false" icon="false"}
...
* **Final Draft**:
    * ***Submitted*** to instructors for review by TBD
    * ***Approved*** by an instructor by TBD
* **Final Submission**:
    * ***Submitted*** via Canvas by TBD
