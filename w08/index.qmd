---
title: "Week 8: Ecological Inference, Propensity Scores"
...
| | Start | End | Topic |
|:- |:- |:- |:- |
| **Lecture** | 6:30pm | 6:40pm | [Final Project Pep Talk &rarr;](#final-projects) |
| | 6:40pm | 7:15pm | [Ecological Inference &rarr;](#ecological-inference) |
| | 7:15pm | 8:00pm | [Controlling For Things vs. Matching/Weighting &rarr;](#propensity-score-weighting) |
| **Break!** | 8:00pm | 8:10pm | |
| | 8:10pm | 8:30pm | [Propensity Score Lab &rarr;](#what-if-we-have-many-covariates) |
| | 8:30pm | 9:00pm | [Causal Inferences with Text &rarr;]()
...
# Final Projects {data-name="Final Projects"}
...
# Ecological Inference (EI) {.crunch-title .title-12 .crunch-img .text-85 data-stack-name="Ecological Inference"}

:::: {layout="[35,65]" layout-align="center" layout-valign="center"}
::: {#ei-left}
...
![[potted_plant]{.material-symbols-outlined} Here **lines** represent **logical constraints** on parameters, while the ellipses are **contours** of the probability distribution **pooling** this information](images/tomography.jpeg){fig-align="center" width="80%"}
...
* [Tomography Plot Demo](https://observablehq.com/@jpowerj/ecological-inference)
...
<tr>
  ...
  <td colspan="2" style="text-align: center; border-bottom: none;"><b>Occupation</b></td>
  <td style="border-bottom: none;"></td>
</tr>
<tr>
  <td style="text-align: center; border-right: 1px solid; border-bottom: 1px solid;"><b>Vote Choice</b></td>
  <td style="text-align: center; border-bottom: 1px solid;">Blue-Collar</td>
  <td style="text-align: center; border-bottom: 1px solid; border-right: 1px solid;">Non-Blue-Collar</td>
  <td style="text-align: center; border-bottom: 1px solid; border-top: 0px solid white;"><b>Total</b></td>
</tr>
<tr>
  <td style="text-align: center; border-right: 1px solid;">Nazis</td>
  <td style="text-align: center;"><span data-qmd="$W_{i1}$"></span></td>
  <td style="text-align: center; border-right: 1px solid;"><span data-qmd="$W_{i2}$"></span></td>
  <td style="text-align: center;"><span data-qmd="$Y_i$"></span></td>
</tr>
<tr>
  <td style="text-align: center; border-right: 1px solid; border-bottom: 1px solid;">Other</td>
  <td style="text-align: center; border-bottom: 1px solid;"><span data-qmd="$1 - W_{i1}$"></span></td>
  <td style="text-align: center; border-right: 1px solid; border-bottom: 1px solid;"><span data-qmd="$1 - W_{i2}$"></span></td>
  <td style="text-align: center; border-bottom: 1px solid;"><span data-qmd="$1 - Y_i$"></span></td>
</tr>
<tr>
  <td style="text-align: center; border-right: 1px solid;"><b>Total</b></td>
  <td style="text-align: center;"><span data-qmd="$X_i$"></span></td>
  <td style="text-align: center; border-right: 1px solid;"><span data-qmd="$1 - X_i$"></span></td>
  <td style="text-align: center;"><span data-qmd="$1$"></span></td>
</tr>
</tbody>
</table>
```

## Stage 1: Tomography Plots
