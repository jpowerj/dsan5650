...
## Studying "Fake News" {.smaller .callout-fw .callout-valign .crunch-img .crunch-p .crunch-quarto-figure .crunch-title .crunch-callout}
...
![](images/real-tired.png){width="90"}

:::

Studying "fake news" with Machine Learning and/or Deep Learning and/or Big Data is a big fad at the moment in Computational Social Science: let's use HMMs to see why it might be more... difficult/complicated than it seems at first 🙈

::::
:::::

:::: {layout="[60,40]" layout-valign="center" layout-align="center"}
::: {#iyengar-text}

![](images/hmm_media.svg){fig-align="center"}
...
which spanned six consecutive days.
