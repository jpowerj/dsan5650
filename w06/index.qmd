---
title: "Week 6: Adaptive Pooling in Multilevel Models, Bayesian Workflow"
...
* Midterm will be **52.5-Hour Take-Home Exam**
* `Midterm` folder will magically appear on [guhub.io](https://guhub.io) at **7:30pm EDT** on **Weds July 1** (immediately after 1hr intro-lecture ends), due **11:59pm EDT** on **Friday July 3**
* $\leadsto$ 1hr intro-lecture recording will be a **video resource** for you, providing necessary background for midterm questions (like the intro-to-Afrobarometer this week!)

# Bayesian Workflow Seed-Planting {.crunch-title .title-11 .crunch-p .ul-block}

*(Terms in HW2 we haven't looked at yet!)*

::: {#workflow-right style="float: right;"}

![](images/hmm_clusters_single_dist.svg){fig-align="center" width="420"}

:::

* [Prior]{.boxed-cb-bg}: Distribution over **parameter values** ***before*** seeing data
* [Prior Predictive]{.boxed-cb-bg}: Distribution over **outcomes**, **before** seeing data
* [Posterior]{.boxed-cb-bg}: Distribution over **parameters**, **after** seeing data
* [Posterior Predictive]{.boxed-cb-bg}: Distribution over **outcomes**, **after** seeing data

# Adaptive Pooling in Multilevel Models {data-stack-name="Adaptive Pooling"}
...
# Bayesian Workflow {.crunch-title .title-11 .crunch-p .ul-block data-stack-name="Bayesian Workflow"}
...
# Demos! {data-stack-name="Demos"}

* **HW2B Part 4: Reducing Uncertainty $\leftrightarrow$ "Sharpening" Knowledge of the State of the World**
* [**Lab 1: Skeptical, Weakly-Informative, and Strongly-Informative Priors**](https://jjacobs.me/dsan5650/writeups/informative-priors/FlatPriors_MiniLab.html)
* [**Lab 2: Weakly and Strongly-Informative NBA Priors**](https://jjacobs.me/dsan5650/writeups/hw2-guide/HW2_Guide.html)
