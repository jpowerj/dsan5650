...
Use the **tabs below** to view the point distributions for different assignments.^[The distributions are imported from Google Sheets mainly for transparency: so that you can see exactly how totals are computed as a sum of the individual points allocated for each test!]
