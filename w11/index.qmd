...
# Sensitivity Analysis 2: How Sensitive Are My Results to *Omitted/Included Variable Bias*? {.smaller data-stack-name="Included Variable Bias"}

* You probably know about **omitted variable bias** from previous classes / intuition...
* But **included variable bias?**
* That's right folks... **colliders** can be agents of chaos, laying waste to our best, most meticulously-measured models

![](images/mood_crop.jpg){fig-align="center"}

## Does Marriage Cause Happiness? {.smaller .crunch-title .crunch-ul .crunch-quarto-figure .table-80 .crunch-img .crunch-p}
...
<tr>
  ...
  <td>At age 65 individuals leave the sample (They move to Boca Raton, Florida)</td>
</tr>
</tbody>
</table>
```
...
#| fig-width: 8
#| fig-height: 3
#| fig-cap: "Happiness by Age (From [PyMC port](https://github.com/pymc-devs/pymc-examples/blob/main/examples/statistical_rethinking_lectures/utils.py) of *Statistical Rethinking* lectures)"
...
for a, h in zip(age_grid, happiness_grid):
    p_marriage = expit(h * beta_happiness + (a - 40 - 18) * beta_age)
